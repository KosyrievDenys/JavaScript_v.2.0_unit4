...
function f1() {
	let out1 = document.querySelector('.out-1').textContent = 1;
}
...
function f2() {
	let out2 = document.querySelector('.out-2').textContent = 2;
}
...
function f3() {
	let out3 = document.querySelector('.out-3').textContent = 3;
}
...
function f6() {
	...
	let out6 = document.querySelector('.out-6').textContent = i6.value;
}
...
function f7() {
	...
	let out7 = document.querySelector('.out-71').textContent = i7;
...
function f8() {
	let out8 = document.querySelector('.out-8').innerHTML = "<div class = 'js2'>new div</div>";
}
...
function f10() {
	...
	let out10 = document.querySelector('.out-10').style.background = i10;
...
function f11() {
	...
	let i112 = document.querySelector('.i-112').value = i111;
}
...
function f12() {
	...
	let out12 = document.querySelector('.out-12').textContent = i12;
...
function f13() {
	...
	let out13 = document.querySelector('.out-13').textContent = i13;
...
function f14() {
	let i14 = document.querySelector('.t-14').value;
	let out14 = document.querySelector('.out-14').textContent = i14;
...
function f16() {
	...
	let out16 = document.querySelector('.out-16').textContent = s16;
}
...
function f17() {
	let i17 = document.querySelector('.s-17').value;
	let out17 = document.querySelector('.out-17').textContent = i17;
}
...
function f18() {
	...
	let i18 = document.querySelector('.i-18').value = s18;
}
...
function f19() {
	...
	let i19 = document.querySelector('.i-19').value = out19;
}
...
function f20() {
let s201 = document.querySelector('.s-201').value;
let s202 = document.querySelector('.s-202').value = s201;
